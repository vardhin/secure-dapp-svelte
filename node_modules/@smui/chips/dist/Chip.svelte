...
onMount(() => {
    instance = new MDCChipFoundation({
        ...
        notifyRemoval: (removedAnnouncement) => {
            dispatch(getElement(), 'SMUIChip:removal', {
                chipId,
                removedAnnouncement,
            }, undefined, true);
        },
        notifySelection: (selected, shouldIgnore) => dispatch(getElement(), 'SMUIChip:selection', {
            chipId,
            selected,
            shouldIgnore,
        }, undefined, true),
