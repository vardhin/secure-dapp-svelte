...
<script>// TODO: Remove this when MDC's segmented button is fixed.
// @ts-ignore
...
export let selected = singleSelect ? undefined : [];
let element;
let instance;
let segmentAccessorMap = {};
let segmentAccessorWeakMap = new WeakMap();
let initialSelected = segments.map((segmentId) => (singleSelect && selected === segmentId) ||
