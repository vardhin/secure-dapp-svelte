...
export let getOptionDisabled = () => false;
export let getOptionLabel = (option) => option == null ? '' : `${option}`;
...
async function handleTextfieldBlur(event) {
    ...
    if (event.relatedTarget &&
        getActiveMenuItems()
            ...
            .indexOf(event.relatedTarget) !== -1) {
        // Wait until the item is selected.
        element.addEventListener('SMUIAutocomplete:selected', () => {
